...
Toggle = Tabs.LGa:AddToggle("MyToggle", {Title = "Speed Hack", Default = true })
...
AutoRipIndra = Tabs.stack:AddToggle("AutoRipIndra", {Title = "Auto Rip Indra", Default = false })
...
if World2 or World3 then 
    local SelectRaid = Tabs.Blog:AddDropdown("SelectRaid", {
        Title = "Select Raid",
        Values = GetNameRaid(),
        Multi = false,
        Default = 1,
...
Toggle = Tabs.pvp:AddToggle("MyToggle", {Title = "Safe Mode", Default = _G.Safe_Mode })
Toggle:OnChanged(function(value)
    _G.Safe_Mode = value
    saveSettings()
end)
...
ToggleMelee = Tabs.spl:AddToggle("ToggleMelee", {Title = "Melee",Description = "", Default = false })
...
ToggleDe = Tabs.spl:AddToggle("ToggleDe", {Title = "Defense",Description = "", Default = false })
...
ToggleSword = Tabs.spl:AddToggle("ToggleSword", {Title = "Sword",Description = "", Default = false })
...
ToggleGun = Tabs.spl:AddToggle("ToggleGun", {Title = "Gun", Description = "",Default = false })
...
ToggleFruit = Tabs.spl:AddToggle("ToggleFruit", {Title = "Fruit",Description = "", Default = false })
