...
TextLabel.Text = "discord.gg/9VbnZd4X"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
...
DropdownTweenSpeed = Tabs.Settings:AddDropdown("DropdownTweenSpeed", {
    Title = "Speed Tween",
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if Auto_Quest_Yama_2 and v:FindFirstChild("HazeESP") and (v.HumanoidRootPart.Position - PosMonsEsp.Position).magnitude <= 300 then
                        ...
                        if not v.HumanoidRootPart:FindFirstChild("BodyVelocity") then
                            vc = Instance.new("BodyVelocity", v.HumanoidRootPart)
...
Toggle = Tabs.Blog:AddToggle("MyToggle", {Title = "Auto Raid", Default = false })
Toggle:OnChanged(function(Value)
    _G.Auto_Dungeon = Value
    saveSettings()
end)		
islandNames = {"Island 5", "Island 4", "Island 3", "Island 2", "Island 1"}		
spawn(function()
    while wait() do
